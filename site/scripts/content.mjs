...
export const WIKI_PAGES = [
  ...
  { slug: 'features', title: 'Features', summary: 'The 8 colour lenses (default: Lineage), Acid Art (ASCII/glyph rendering), 5 themes, 10 Life-like rules, opt-in multiplayer, video export, the history ribbon, the Time Sculpture, branching, the field guide, experiments, the audio instrument, cinematic mode, and the guided tour.' },
